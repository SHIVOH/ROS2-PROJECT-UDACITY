...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<example_interfaces::srv::AddTwoInts>::SharedPtr client =
    node->create_client<example_interfaces::srv::AddTwoInts>("multiply_two_ints");
  ...
  {
    RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Hello Udacity reviewer! the product is: %ld", result.get()->sum);
  } else {
